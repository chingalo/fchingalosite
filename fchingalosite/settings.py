...
CMS_TEMPLATES = ( 
	...
	('downloadreport.html', gettext('download report ')),
	('downloadreference.html', gettext('download reference ')),
	('searchreport.html', gettext('search report ')),
	('searchreference.html', gettext('search reference ')),
